...
export function Providers({ children }) {
    ...
    return (
        <>
            ...
            >
                <svg id="path_animator" className='absolute top-0 left-0 z-50 pointer-events-none scale-135' width="100vw" height="100vh" viewBox="0 0 164 86" fill="none" xmlns="http://www.w3.org/2000/svg">
